                ...
                <div class="card-body">
                    ...
                    @endif
                        <div class="form-group">
                            ...
                            {!! Form::text('title', isset($category) ? $category->title : '', ['class'=>'form-control','placeholder'=>'Nhập tên danh mục...','id'=>'slug','onkeyup'=>'ChangeToSlug()']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('status', ['1'=>'Hiển thị','0'=>'Ẩn'],isset($category) ? $category->status : '', ['class'=>'form-controll']) !!}
